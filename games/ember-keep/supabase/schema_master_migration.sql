-- ================================================================
-- EMBER KEEP — Master Database Migration Script
-- Run this script in the Supabase SQL Editor (https://supabase.com/dashboard)
-- ================================================================

-- 1. Add Campaign Persistence Columns to Characters Table
...
-- 2. Fixed & Optimized Atomic Dungeon Encounter Procedure
