      ...
      dbChars.forEach(row => {
        ...
        if (slot >= 1 && slot <= 5) {
          ...
          accountData.characterSlots[slot] = {
            ...
            dungeonProgress: row.dungeon_progress || (localChar ? (localChar.dungeonProgress || localChar.dungeon_progress) : {}),
            dungeon_progress: row.dungeon_progress || (localChar ? (localChar.dungeonProgress || localChar.dungeon_progress) : {}),
    ...
    try {
      ...
      if (user) {
        ...
        const newChar = {
          ...
          dungeonProgress: row.dungeon_progress || {},
